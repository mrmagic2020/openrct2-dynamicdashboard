import { compute, groupbox, horizontal, label, vertical, window } from "openrct2-flexui"
          ...
          vertical(
            [
              ...
              groupbox({ // Guest
                ...
                content: [
                  label({
                    text: compute(baseData.local.guest.guest_generation_total.store, (value) => language.ui.main.label.guest_generation_total + value.toString())
                  }),
                  label({
                    text: compute(baseData.local.guest.guest_admission_total.store, (value) => language.ui.main.label.guest_admission_total + value.toString())
                  }),
                  label({
                    text: compute(baseData.local.guest.guest_count_current.store, (value) => language.ui.main.label.guest_count_current + value.toString())
                  }),
                  label({
                    text: compute(baseData.local.guest.guest_soft_cap.store, (value) => language.ui.main.label.guest_soft_cap + value.toString())
                  }),
                  label({
            ...
            [
              groupbox({ // Rides
                ...
                content: [
                  horizontal([
                    label({
                      text: compute(baseData.local.rides.ride_count_total.store, (value) => language.ui.main.label.ride_count_total + value.toString())
                    }),
                    label({
                      text: compute(baseData.local.rides.ride_count_flat.store, (value) => language.ui.main.label.ride_count_flat + value.toString())
                    }),
                    label({
                      text: compute(baseData.local.rides.ride_count_tracked.store, (value) => language.ui.main.label.ride_count_tracked + value.toString())
                    })
                  ]),
                  label({
                    text: compute(baseData.local.rides.ride_excitement_ave.store, (value) => language.ui.main.label.ride_excitement_ave + value.toString())
                  }),
                  label({
                    text: compute(baseData.local.rides.ride_intensity_ave.store, (value) => language.ui.main.label.ride_intensity_ave + value.toString())
                  }),
                  label({
                    text: compute(baseData.local.rides.ride_nausea_ave.store, (value) => language.ui.main.label.ride_nausea_ave + value.toString())
                  }),
                  label({
                    text: compute(baseData.local.rides.ride_value_ave.store, (value) => language.ui.main.label.ride_value_ave + value.toString())
                  }),
                  label({
                    text: compute(baseData.local.rides.ride_price_ave.store, (value) => language.ui.main.label.ride_price_ave + value.toString())
                  }),
                  label({
                    text: compute(baseData.local.rides.ride_admission_ave.store, (value) => language.ui.main.label.ride_admission_ave + value.toString())
                  }),
                  groupbox({ // Crashes
                    ...
                    content: [
                      horizontal([
                        label({
                          text: compute(baseData.local.rides.crash_count_total.store, (value) => language.ui.main.label.crash_count_total + value.toString())
                        }),
                        label({
                          text: compute(baseData.local.rides.crash_count_into_vehicle.store, (value) => language.ui.main.label.crash_count_into_vehicle + value.toString())
                        })
                      ]),
                      horizontal([
                        label({
                          text: compute(baseData.local.rides.crash_count_into_land.store, (value) => language.ui.main.label.crash_count_into_land + value.toString())
                        }),
                        label({
                          text: compute(baseData.local.rides.crash_count_into_water.store, (value) => language.ui.main.label.crash_count_into_water + value.toString())
                        })
                      ])
                    ]
                  })
